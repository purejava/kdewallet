...
public abstract class KWalletIface extends AbstractInterface implements KWallet {

    public KWalletIface(DBusConnection connection, List<Class<? extends DBusSignal>> signals,
